...
var file_recordstats_proto_rawDesc = []byte{
	...
	0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xe5, 0x05, 0x0a, 0x06, 0x43, 0x6f, 0x6e, 0x66,
	...
	0x74, 0x54, 0x69, 0x6d, 0x65, 0x48, 0x69, 0x67, 0x68, 0x1a, 0x64, 0x0a, 0x0a, 0x46, 0x69, 0x6c,
	...
	0x61, 0x6c, 0x69, 0x64, 0x12, 0x23, 0x0a, 0x0d, 0x6c, 0x61, 0x73, 0x74, 0x5f, 0x61, 0x75, 0x64,
	0x69, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0c, 0x6c, 0x61, 0x73,
	0x74, 0x41, 0x75, 0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x4a, 0x0a, 0x0c, 0x43, 0x6f, 0x6d,
	...
	0x73, 0x43, 0x6f, 0x73, 0x74, 0x42, 0x2b, 0x5a, 0x29, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
...
var file_recordstats_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_recordstats_proto_goTypes = []interface{}{
	...
	nil,                                 // 4: recordstats.Config.FiledTimeEntry
	nil,                                 // 5: recordstats.Config.LbLastTimeEntry
	nil,                                 // 6: recordstats.Config.LbLastTimeHighEntry
	(proto.ReleaseMetadata_FileSize)(0), // 7: recordcollection.ReleaseMetadata.FileSize
}
var file_recordstats_proto_depIdxs = []int32{
	...
	4, // 3: recordstats.Config.filed_time:type_name -> recordstats.Config.FiledTimeEntry
	5, // 4: recordstats.Config.lb_last_time:type_name -> recordstats.Config.LbLastTimeEntry
	6, // 5: recordstats.Config.lb_last_time_high:type_name -> recordstats.Config.LbLastTimeHighEntry
	7, // 6: recordstats.Config.FiledEntry.value:type_name -> recordcollection.ReleaseMetadata.FileSize
