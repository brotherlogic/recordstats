...
func RegisterRecordStatsServiceServer(s grpc.ServiceRegistrar, srv RecordStatsServiceServer) {
	s.RegisterService(&RecordStatsService_ServiceDesc, srv)
}
...
// RecordStatsService_ServiceDesc is the grpc.ServiceDesc for RecordStatsService service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var RecordStatsService_ServiceDesc = grpc.ServiceDesc{
